...
//        }
        ...
        robot.telemetry.addGroupHeader("CONTROLS", EnhancedTelemetry.COLOR_BLUE);
        robot.telemetry.addData("Active Layer", actionLayer);
        robot.telemetry.addData("Auto Sorting", autoSorting ? "ON" : "OFF");
        robot.telemetry.addData("Slow Mode", ninjaMode ? "ON" : "OFF");
    }
